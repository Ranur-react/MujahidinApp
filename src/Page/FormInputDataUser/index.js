      ...
      <View style = {styles.container}>
        ...
        <ScrollView style = {{marginTop: 30, marginHorizontal: 20}}>
          <View style = {{marginBottom: 15}}>
            ...
            <TextInput placeholder = 'Masukkan id user' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>

          <View style = {{marginBottom: 15}}>
            <Text style = {styles.txtlabel}>Nama User</Text>
            <TextInput placeholder = 'Masukkan nama user' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>

          <View style = {{marginBottom: 15}}>
            <Text style = {styles.txtlabel}>Username</Text>
            <TextInput placeholder = 'Masukkan username' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>

          <View style = {{marginBottom: 15}}>
            <Text style = {styles.txtlabel}>Password</Text>
            <TextInput placeholder = 'Masukkan password' placeholderTextColor = "grey" secureTextEntry = {this.state.secureTextEntry} style = {styles.txtinput} />
          </View>

          <View style = {{marginBottom: 15}}>
            <Text style = {styles.txtlabel}>Level</Text>
            <TextInput placeholder = 'Masukkan level user' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>
