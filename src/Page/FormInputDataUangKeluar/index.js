      ...
      <View style = {styles.container}>
        ...
        <ScrollView style = {{marginTop: 30, marginHorizontal: 20}}>
          <View style = {{marginBottom: 15}}>
            ...
            <TextInput placeholder = 'Masukkan id uang keluar' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>
          ...
          <View style = {{marginBottom: 15}}>
            ...
            <TextInput placeholder = 'Masukkan uraian' placeholderTextColor = "grey" style = {styles.txtinput} />
          </View>
